...
let abstractionsLecture = Lecturer.Lecture(subject: University.Subject.programmingAbstractions, faculty: University.Faculty.macs, startDate: "21:00", endDate: "23:00", roomNumber: "200")
let weekdays = Lecturer.Weekday(lectures: [abstractionsLecture])
let timetable = Lecturer.Timetable(weekDays: [weekdays])


let iosLecturer = Lecturer(name: "Vasili", surname: "Baramidze", faculty: University.Faculty.macs, subjectsTeaching: [University.Subject.programmingAbstractions, University.Subject.math], timetable: timetable)
